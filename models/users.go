...
type User struct {
	...
	UserID    int         `csv:"user_id" boil:"user_id" json:"user_id" toml:"user_id" yaml:"user_id"`
	Name      null.String `csv:"name" boil:"name" json:"name,omitempty" toml:"name" yaml:"name,omitempty"`
	CreatedAt time.Time   `csv:"created_at" boil:"created_at" json:"created_at" toml:"created_at" yaml:"created_at"`
	UpdatedAt time.Time   `csv:"updated_at" boil:"updated_at" json:"updated_at" toml:"updated_at" yaml:"updated_at"`
...
var (
	userAllColumns            = []string{"id", "user_id", "name", "created_at", "updated_at"}
